      ...
      <div className="mx-auto max-w-6xl px-4 py-8 sm:px-6 lg:px-8">
        <div className="flex flex-col gap-6 md:flex-row md:items-start md:justify-between">
          ...
          <nav className="flex flex-wrap gap-x-5 gap-y-2 text-sm" aria-label="Footer navigation">
            <Link href="/work" className="hover:text-palm-green">Work</Link>
            <Link href="/expertise" className="hover:text-palm-green">Expertise</Link>
            <Link href="/about" className="hover:text-palm-green">About</Link>
            <Link href="/contact" className="hover:text-palm-green">Contact</Link>
          </nav>
