...
export const metadata: Metadata = {
  title: 'Engineering Expertise — React Native, Next.js, FastAPI & AI | Joel Mbaka',
  description:
    'Explore Joel Mbaka’s engineering expertise across React Native mobile apps, Next.js web applications, FastAPI/PostgreSQL backends, and practical AI integrations and automation.',
  alternates: { canonical: '/expertise' },
  openGraph: {
    type: 'website',
    url: '/expertise',
    title: 'Engineering Expertise | Joel Mbaka',
    description: 'Mobile, web, backend, data, and AI integration expertise supported by production product work.',
  },
  twitter: {
    ...
    <main className="mx-auto max-w-6xl px-4 pb-16 pt-28 sm:px-6 lg:px-8">
      ...
      <header className="max-w-4xl">
        ...
        <p className="mt-6 max-w-3xl text-lg leading-8 text-gray-600 dark:text-gray-300">
          These capability pages make the technical breadth behind my project work easier to evaluate: what I build, the systems I own, and the production products that provide evidence for each area.
        </p>
      </header>

      <section className="mt-12 grid gap-5 md:grid-cols-2" aria-label="Engineering expertise areas">
        {expertiseAreas.map((area) => (
          <article key={area.slug} className="rounded-3xl border border-gray-200 bg-white p-7 dark:border-gray-800 dark:bg-gray-900/70">
            ...
            <div className="mt-5 flex flex-wrap gap-2">
              {area.technologies.slice(0, 6).map((technology) => (
