    ...
    <main className="max-w-5xl mx-auto px-4 sm:px-6 pt-24">
      ...
      <section className="mb-10">
        ...
        <ul className="space-y-2">
          <li>
            <Link href="/challenges/warrantyit" className="text-blue-600 hover:underline">WarrantyIT</Link>
            <span className="ml-2 text-xs text-gray-500">{siteUrl && `${siteUrl}/challenges/warrantyit`}</span>
          </li>
        </ul>
      </section>
