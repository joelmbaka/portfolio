...
async def main() -> None:
    ...
    export_dir = Path(settings.linkedin_export_dir)
    ...
    json_path = export_dir / f"linkedin_jobs_{stamp}.json"
    csv_path = export_dir / f"linkedin_jobs_{stamp}.csv"
