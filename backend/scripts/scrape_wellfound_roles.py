...
def make_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Scrape Wellfound role pages to JSON or CSV.")
    parser.add_argument("--out", default="exports/wellfound_jobs.json")
    ...
    parser.add_argument(
        ...
        help="Role key to scrape. Repeatable. Defaults to all initial roles.",
    )
    return parser
...
async def main() -> None:
    ...
    jobs = await scrape_wellfound_roles(
        selected,
        headless=headless,
